...
model_path = '/users/afatihi/work-detect/fractex2D.pt/outputs_BM_/unet-huber-rmspro-0.1/2025-12-02_10-59'
# '/users/afatihi/work-detect/fractex2D.pt/outputs_BM_/unet-huber-rmspro-0.1/2025-08-07_09-28'
# model_path = '/users/afatihi/work-detect/fractex2D.pt/multirun_BM_/segformer/2025-08-30_16-50/model=sm_segformer'
# model_path = '/users/afatihi/work-detect/fractex2D.pt/multirun_BM_/segformer/2025-11-11_08-33/dataset.datasets=samsu19,model=sm_segformer'
# model_path = '/users/afatihi/work-detect/fractex2D.pt/multirun_BM_/segformer/2025-11-11_08-33/dataset.datasets=ovaskainen23,model=sm_segformer'
# model_path = '/users/afatihi/work-detect/fractex2D.pt/multirun_BM_/segformer/2025-11-11_08-33/dataset.datasets=matteo21,model=sm_segformer'
# model_path = '/users/afatihi/work-detect/fractex2D.pt/multirun_BM_/ds-Alone/2025-09-02_10-31/dataset.datasets=matteo21'
# model_path = '/users/afatihi/work-detect/fractex2D.pt/multirun_BM_/ds-Alone/2025-09-02_10-31/dataset.datasets=ovaskainen23'
# model_path = '/users/afatihi/work-detect/fractex2D.pt/multirun_BM_/ds-Alone/2025-09-02_10-31/dataset.datasets=samsu19'
...
def main(cfg: DictConfig):
    ...
    model.cuda()
    model.load_state_dict(torch.load(os.path.join(model_path, 'final_model.pt'),
